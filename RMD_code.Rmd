...
kable(dataInfo, caption = "Data")

```



A high level data cleaning is then carried out. This includes preparing data types and some simple data manipulation as follows:
