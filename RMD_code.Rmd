...
###First Letter of the Cabin Name

Unfortunately, `r round(sum(dataAll$Cabin == "")/nrow(dataAll),2)`% of the Cabin Names are null in the data set and there is no specified reason why these are missing.
...
###Number of Cabins associated with the Ticket
